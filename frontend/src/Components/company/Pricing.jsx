...
const Pricing = () => {
  ...
  const handleIndividualPage = (id) => {
    switch (id) {
      case 1:
        navigate(`/premium-images/${id}`);
        break;
      case 2:
        navigate(`/premium-vectors/${id}`);
        break;
      case 3:
        navigate(`/animation-templates/${id}`);
        break;
      case 4:
        navigate(`/premium-icons/${id}`);
        break;
      default:
        null;
    }
  ...
  return (
    <section>
      <div
        className="mx-auto w-full flex flex-col lg:flex-row gap-10 lg:gap-16 xl:gap-28 items-center justify-center lg:p-16 xl:p-32 p-10 mt-10 lg:mt-0"
        style={{
      ...
      <div className="flex flex-col items-center justify-center py-40 px-7 bg-[#F5F5F5]">
        ...
        <div className="flex flex-col lg:flex-row gap-10 text-[#727272] mt-24">
          <div className="p-10 bg-white rounded-md">
            ...
            <ul
              className="text-[16px] mt-4 mb-5 pl-10"
            ...
            <div
              onClick={() => {
                handleIndividualPage(1);
              }}
              onMouseEnter={() => {
                handleIndividual("1");
              }}
              className={`flex flex-row gap-24 justify-between items-center py-3 pl-10 pr-5 border ${
                individual === "1" ? "border-black" : "border-gray-250"
              } rounded-lg my-5 cursor-pointer`}
            >
              <div>
                <p className="text-[26px] font-bold">Premium Images</p>
                <div className="flex flex-row gap-5 text-[16px] mt-2">
                  <p>160 images</p>
                  <p>HD Resolution</p>
                </div>
              </div>
            ...
            <div
              onClick={() => handleIndividualPage(2)}
              onMouseEnter={() => {
                handleIndividual("2");
              }}
              className={`flex flex-row gap-24 justify-between items-center py-3 pl-10 pr-5 border ${
                individual === "2" ? "border-black" : "border-gray-250"
              } rounded-lg my-5 cursor-pointer`}
            >
              <div>
            ...
            <div
              onClick={() => handleIndividualPage(3)}
              onMouseEnter={() => {
                handleIndividual("3");
              }}
              className={`flex flex-row gap-24 justify-between items-center py-3 pl-10 pr-5 border ${
                individual === "3" ? "border-black" : "border-gray-250"
              } rounded-lg my-5 cursor-pointer`}
            >
              <div>
            ...
            <div
              onClick={() => handleIndividualPage(4)}
              onMouseEnter={() => {
                handleIndividual("4");
              }}
              className={`flex flex-row gap-24 justify-between items-center py-3 pl-10 pr-5 border ${
                individual === "4" ? "border-black" : "border-gray-250"
              } rounded-lg my-5 cursor-pointer`}
            >
              <div>
            ...
            <button className="nav-btn bg-[#4A16D8] text-white border border-[#4A16D8] font-bold py-1">
              Buy Premium Images
            </button>
          </div>
          <div className="p-10 bg-white rounded-md ">
            ...
            <div
              ...
              className={`flex flex-row gap-24 justify-between items-center py-3 pl-10 pr-5 border ${
                team === "1" ? "border-black" : "border-gray-250"
              } rounded-lg my-5 cursor-pointer`}
            >
              <div>
                <p className="text-[26px] font-bold">Premium Images</p>
            ...
            <div
              onClick={() => {
                handleIndividualPage(2);
              }}
              onMouseEnter={() => {
                handleTeam("2");
              }}
              className={`flex flex-row gap-24 justify-between items-center py-3 pl-10 pr-5 border ${
                team === "2" ? "border-black" : "border-gray-250"
              } rounded-lg my-5 cursor-pointer`}
            >
              <div>
                <p className="text-[26px] font-bold">Premium Vectors</p>
            ...
            <div
              onClick={() => {
                handleIndividualPage(3);
              }}
              onMouseEnter={() => {
                handleTeam("3");
              }}
              className={`flex flex-row gap-24 justify-between items-center py-3 pl-10 pr-5 border ${
                team === "3" ? "border-black" : "border-gray-250"
              } rounded-lg my-5 cursor-pointer`}
            >
              <div>
                <p className="text-[26px] font-bold">Premium Icons</p>
            ...
            <div
              onClick={() => {
                handleIndividualPage(4);
              }}
              onMouseEnter={() => {
                handleTeam("4");
              }}
              className={`flex flex-row gap-24 justify-between items-center py-3 pl-10 pr-5 border ${
                team === "4" ? "border-black" : "border-gray-250"
              } rounded-lg my-5 cursor-pointer`}
            >
              <div>
                <p className="text-[26px] font-bold">Animation Templates</p>
            ...
            <button className="nav-btn bg-[#4A16D8] text-white border border-[#4A16D8] mx-auto font-bold py-1">
              Buy Premium Images
            </button>
          </div>
        </div>
      ...
      <div className="px-7 md:px-20 lg:px-40 py-20 text-[#727272] bg-white">
        ...
        {Accordian.map((items) => (
          <div
            key={items.q}
            className="p-4 rounded-lg border border-[#505153] my-5"
          >
            <button
            ...
            >
              ...
              {accordianOpen ? (
                <img loading="lazy" src="./pricing/faqup.png" alt="arrowdown" />
              ) : (
                <img loading="lazy" src="./pricing/faqdown.png" alt="arrowup" />
              )}
            </button>
            <div
              className={`grid overflow-hidden transition-all duration-300 ease-in-out mr-[200px] ${
                accordianOpen
                  ? "grid-rows-[1fr] opacity-100"
                  : "grid-rows-[0fr] opacity-0"
              }`}
            >
              <p className="overflow-hidden text-[16px] font-light ">
                {items.a}
              </p>
            </div>
          </div>

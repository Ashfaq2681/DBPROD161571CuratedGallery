...
export default function Footer() {
  return (
    <footer>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-4 bg-gray-950">
        <div className="p-4">
          <div>
      ...
      <div className="flex bg-slate-950 justify-center">
        ...
        <span className="text-gray-500 py-4 ml-5 flex w-8/12 text-sm">
          ...
          Library. Whether you are working on a professional project, sprucing
          up your personal blog, or simply seeking visual inspiration, we&#39ve
          got you covered
        </span>
      </div>

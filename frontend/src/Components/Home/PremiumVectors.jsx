import vector from "../../assets/icons/vector4.png";
import sun from "../../assets/icons/Ellipse.png";
export default function PremiumVectors() {
  return (
    <div>
      <div>
        <div className=" md:flex lg:flex xl:flex my-12">
          <div className="w-full  lg:w-6/12 flex flex-col">
            <div className="flex  items-center justify-center p-3 ">
              <span className="my-12 p-5 ">
                <h1 className="text-gray-500 font-bold text-[50px]">
            ...
            <span className="flex justify-start ml-20">
              <img src={sun} alt="sun" height={70} width={70} />
            </span>
          </div>
